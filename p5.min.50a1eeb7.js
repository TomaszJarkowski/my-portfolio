...
},{}],"vanta-master/vendor/p5.min.js":[function(require,module,exports) {
var define;
...
!function (a) {
  if ("object" == (typeof exports === "undefined" ? "undefined" : (0, _typeof2.default)(exports)) && "undefined" != typeof module) module.exports = a();else if ("function" == typeof define && define.amd) define([], a);else {
    var b;
  ...
  return function a(b, c, d) {
    ...
    3: [function (a, b, c) {
      (function (b) {
        ...
        f.TYPED_ARRAY_SUPPORT = void 0 !== b.TYPED_ARRAY_SUPPORT ? b.TYPED_ARRAY_SUPPORT : d(), f.TYPED_ARRAY_SUPPORT ? (f.prototype.__proto__ = Uint8Array.prototype, f.__proto__ = Uint8Array) : (f.prototype.length = void 0, f.prototype.parent = void 0), f.isBuffer = function (a) {
          ...
          var c;
          if (void 0 === b) for (b = 0, c = 0; c < a.length; c++) {
            b += a[c].length;
          }
          var d = new f(b),
              e = 0;
        ...
        f.prototype.slice = function (a, b) {
          ...
          var e,
              g = d - c;
          if (this === a && c < b && b < d) for (e = g - 1; e >= 0; e--) {
            a[e + b] = this[e + c];
          ...
          if (c !== b && 0 !== this.length) {
            ...
            var d;
            if ("number" == typeof a) for (d = b; d < c; d++) {
              this[d] = a;
            } else {
              var e = R(a.toString()),
                  f = e.length;
    ...
    4: [function (b, c, d) {
      (function (e, f) {
        !function (b, e) {
          "object" == (0, _typeof2.default)(d) && void 0 !== c ? c.exports = e() : "function" == typeof a && a.amd ? a(e) : b.ES6Promise = e();
        }(this, function () {
          "use strict";
          ...
          function p(a) {
            var b = this;
            if (a && "object" == (0, _typeof2.default)(a) && a.constructor === b) return a;
            var c = new b(q);
            return y(c, a), c;
          }
    ...
    9: [function (b, c, d) {
      (function (e) {
        !function (b, e) {
          "object" == (0, _typeof2.default)(d) && void 0 !== c ? e(d) : "function" == typeof a && a.amd ? a(["exports"], e) : e(b.opentype = b.opentype || {});
        }(this, function (a) {
          "use strict";
          ...
          function la(a, b) {
            var c = this;
            if (this.font = a, this.glyphs = {}, Array.isArray(b)) for (var d = 0; d < b.length; d++) {
              c.glyphs[d] = b[d];
            }
          ...
          function Da(a, b, c) {
            var d,
                ...
                f = new Ne.Parser(a, b),
                g = f.parseCard8();
            if (0 === g) for (var h = f.parseCard8(), i = 0; i < h; i += 1) {
          ...
          function Od(a) {
            a = a || {}, a.empty || (Jb(a.familyName, "When creating a new Font object, familyName is required."), Jb(a.styleName, "When creating a new Font object, styleName is required."), Jb(a.unitsPerEm, "When creating a new Font object, unitsPerEm is required."), Jb(a.ascender, "When creating a new Font object, ascender is required."), Jb(a.descender, "When creating a new Font object, descender is required."), Jb(a.descender < 0, "Descender should be negative (e.g. -512)."), this.names = {
              fontFamily: {
                en: a.familyName || " "
              },
              fontSubfamily: {
          ...
          De.MACSTRING = function (a, b) {
            ...
            var c = [];
            if (Array.isArray(b)) for (var d = 0; d < b.length; d += 1) {
              ze.argument(a.length === b.length, "Not enough arguments given for type" + b), c = c.concat(De.OPERAND(a[d], b[d]));
            } else if ("SID" === b) c = c.concat(De.NUMBER(a));else if ("offset" === b) c = c.concat(De.NUMBER32(a));else if ("number" === b) c = c.concat(De.NUMBER(a));else {
          ...
          var uf,
            ...
            setRelative: function setRelative(a, b, c, d, e) {
          ...
          Kb.prototype.exec = function (b, c) {
            ...
            if (!(this._errorState > 2)) {
              ...
              if (!e || e.ppem !== c) {
                ...
                var g = d.tables.cvt;
                if (g) for (var h = e.cvt = new Array(g.length), i = c / d.unitsPerEm, j = 0; j < g.length; j++) {
                  h[j] = g[j] * i;
                } else e.cvt = [];
    ...
    19: [function (a, b, c) {
      ...
      var d = a("./constants");
      b.exports = {
        modeAdjust: function modeAdjust(a, b, c, e, f) {
          return f === d.CORNER ? {
            x: a,
            y: b,
            w: c,
    ...
    21: [function (a, b, c) {
      ...
      var d = a("./constants"),
        ...
        window.DeviceOrientationEvent && (this._events.deviceorientation = null), window.DeviceMotionEvent && !window._isNodeWebkit && (this._events.devicemotion = null), this._start = function () {
          ...
          var a = this._isGlobal ? window : this;
          if ("function" == typeof a.preload) for (var b in this._preloadMethods) {
    ...
    28: [function (a, b, c) {
      ...
      f.Renderer = function (a, b, c) {
        ...
        return "object" == (0, _typeof2.default)(a = a || this._textFont) && a.font && a.font.supported;
    ...
    29: [function (a, b, c) {
      ...
      d.Renderer2D = function (a, b, c) {
        ...
        if (c instanceof d.Image) this.drawingContext.save(), this.drawingContext.setTransform(1, 0, 0, 1, 0, 0), this.drawingContext.scale(e._pixelDensity, e._pixelDensity), this.drawingContext.drawImage(c.canvas, a, b), this.loadPixels.call(e), this.drawingContext.restore();else {
          var f = 0,
              g = 0,
              h = 0,
              i = 0,
        ...
        if (!c || h !== f.POLYGON && null !== h) {
          if (!d || h !== f.POLYGON && null !== h) {
            if (!e || h !== f.POLYGON && null !== h) {
              ...
              } else if (h === f.TRIANGLE_STRIP) for (k = 0; k + 1 < m; k++) {
      ...
      d.prototype.createCanvas = function (a, b, c) {
        ...
        if (d._validateParameters("resizeCanvas", arguments), this._renderer) {
          ...
          for (var f in this.drawingContext) {
            ...
            "object" != (0, _typeof2.default)(g) && "function" != typeof g && (e[f] = g);
          }
    ...
    45: [function (a, b, c) {
      ...
      function d(a, b) {
        var c = {};
        if (void 0 === (b = b || [])) for (var d = 0; d < a.length; d++) {
          b[d.toString()] = d;
        }
      ...
      a("../core/error_helpers"), i.prototype.loadJSON = function () {
        ...
        for (var a, b, c, d = arguments[0], e = {}, f = "json", g = 1; g < arguments.length; g++) {
          var h = arguments[g];
          "string" == typeof h ? "jsonp" !== h && "json" !== h || (f = h) : "function" == typeof h ? a ? b = h : a = h : "object" == (0, _typeof2.default)(h) && h.hasOwnProperty("jsonpCallback") && (f = "jsonp", c = h);
        }
        ...
        var k = arguments.length - g,
            l = arguments[0];
        if (2 === k && "string" == typeof l && "object" == (0, _typeof2.default)(arguments[1])) d = new Request(l, arguments[1]), b = arguments[2], c = arguments[3];else {
          for (var m, n = "GET", o = 1; o < arguments.length; o++) {
            var p = arguments[o];
            if ("string" == typeof p) "GET" === p || "POST" === p || "PUT" === p || "DELETE" === p ? n = p : "json" === p || "jsonp" === p || "binary" === p || "arrayBuffer" === p || "xml" === p || "text" === p ? a = p : m = p;else if ("number" == typeof p) m = p.toString();else if ("object" == (0, _typeof2.default)(p)) {
              if (p.hasOwnProperty("jsonpCallback")) for (var q in p) {
                f[q] = p[q];
    ...
    46: [function (a, b, c) {
      ...
      d.Table = function (a) {
        ...
        var c = [];
        if ("string" == typeof b) for (var d = 0; d < this.rows.length; d++) {
        ...
        var c = [];
        if ("number" == typeof b) for (var d = 0; d < this.rows.length; d++) {
        ...
        var b = [];
        if ("string" == typeof a) for (var c = 0; c < this.rows.length; c++) {
        ...
        if (void 0 === b) for (var g = 0; g < this.columns.length; g++) {
        ...
        var b = new RegExp(" ", "g");
        if (void 0 === a) for (var c = 0; c < this.columns.length; c++) {
    ...
    57: [function (a, b, c) {
      ...
      function h(a, b) {
        if ("object" != (0, _typeof2.default)(a)) a = b;else for (var c in b) {
          void 0 === a[c] && (a[c] = b[c]);
        }
        return a;
      }
      ...
      y.Font = function (a) {
        ...
        var e = 3;
        return "string" == typeof a && arguments.length > 2 ? a = this._getPath(a, b, c, d) : "object" == (0, _typeof2.default)(b) && (d = b), d && "number" == typeof d.decimals && (e = d.decimals), a.toPathData(e);
      }, y.Font.prototype._getSVG = function (a, b, c, d) {
        var e = 3;
        return "string" == typeof a && arguments.length > 2 ? a = this._getPath(a, b, c, d) : "object" == (0, _typeof2.default)(b) && (d = b), d && ("number" == typeof d.decimals && (e = d.decimals), "number" == typeof d.strokeWidth && (a.strokeWidth = d.strokeWidth), void 0 !== d.fill && (a.fill = d.fill), void 0 !== d.stroke && (a.stroke = d.stroke)), a.toSVG(e);
      }, y.Font.prototype._renderPath = function (a, b, c, d) {
        var e,
            f = d && d.renderer || this.parent._renderer,
            g = f.drawingContext;
        e = "object" == (0, _typeof2.default)(a) && a.commands ? a.commands : this._getPath(a, b, c, d).commands, g.beginPath();
    ...
    68: [function (a, b, c) {
      ...
      "undefined" != typeof Float32Array && (e = Float32Array, f = function f(a) {
        ...
        if (b) b.transpose3x3(this.mat3);else for (var c = 0; c < 9; c++) {
          this.mat3[c] = 0;
        }
        return this;
    ...
    74: [function (a, b, c) {
      ...
      var e = function e(a, b, c, _e2, f, g, h) {
        a = a <= 0 ? 1 : a, b = b < 0 ? 0 : b, c = c <= 0 ? a : c, _e2 = _e2 < 3 ? 3 : _e2, f = f < 1 ? 1 : f, g = void 0 === g || g, h = void 0 === h ? 0 !== b : h;
        var i,
            j,
            k,
            l,
        ...
        for (i = n; i <= o; ++i) {
          ...
          for (i < 0 ? (t = 0, s = 0, r = a) : i > f ? (t = c, s = 1, r = b) : r = a + (b - a) * s, -2 !== i && i !== f + 2 || (r = 0), t -= c / 2, p[i] = 0 === r ? 1 : _e2, j = 0; j < p[i]; ++j) {
            var u = j / _e2;
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","vanta-master/vendor/p5.min.js"], null)
//# sourceMappingURL=/p5.min.50a1eeb7.js.map